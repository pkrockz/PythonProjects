...
#v1.3 Major overhaul in the code for easier maintainence and removed Consecutive Character Check
#v1.3(.1) Added a 'Planned' Section
#v1.3(.2) Optimised code
#v1.4 Major overhaul in the code for easier maintainence:
#     1. Used functions
#     2. Added Password Rating System
#     3. Added Number Inclusion as another criteria
#     4. Added Password policies
#v1.5 Updated function calling to make it more efficient and removed Password polices section
#v1.6(Final) Included GUI and optimised code
